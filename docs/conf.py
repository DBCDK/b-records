...
# -*- coding: utf-8 -*-
#
# b-records documentation build configuration file, created by
# sphinx-quickstart on Wed Jan  9 12:19:49 2019.
#
...
htmlhelp_basename = 'b-recordsdoc'
...
latex_documents = [
    (master_doc, 'b-records.tex', 'b-records Documentation',
     'ait', 'manual'),
]
...
man_pages = [
    (master_doc, 'b-records', 'b-records Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'b-records', 'b-records Documentation',
     author, 'b-records', 'One line description of project.',
     'Miscellaneous'),
]
